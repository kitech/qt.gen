...
extern {
    ...
    fn C_ZN12QApplicationC2ERiPPci(this: *mut libc::c_void, argc: *mut int32_t, argv: *mut *mut libc::c_char, a: int32_t);
    fn C_ZN12QApplication4execEv(this: *mut libc::c_void) -> libc::int32_t;
}
...
pub fn NewClass() {
    ...
    unsafe {
        ...
        C_ZN12QApplicationC2ERiPPci(this, &mut 0 as *mut int32_t, 0 as *mut *mut c_char, 0)}; // OK
    // println!("this={}", this);
    println!("ret={}", "iop");
    let ret = unsafe {C_ZN12QApplication4execEv(this)};
    println!("ret={}", ret);
}
