...
func (this *GenerateGov2) genPlainTmplInstClses() {
}

func (this *GenerateGov2) genTydefTmplInstClses() {
...
func (this *GenerateGov2) genTemplateInstant(tmplClsCursor, argClsCursor clang.Cursor) {
...
func (this *GenerateGov2) genTemplateMethod(cursor, parent clang.Cursor, argClsCursor clang.Cursor) {
...
func (this *GenerateGov2) genTemplateInterface(tmplClsCursor, argClsCursor clang.Cursor) {
...
func (this *GenerateGov2) genTemplateInterfaceSignature(cursor, parent clang.Cursor, argClsCursor clang.Cursor) {
	clsName := argClsCursor.Spelling()
	elemClsName := clsName[:strings.LastIndexAny(clsName, "LHSM")]
