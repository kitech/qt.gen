...
func (this *GenerateNim) genPlainTmplInstClses() {
}

func (this *GenerateNim) genTydefTmplInstClses() {
...
func (this *GenerateNim) genTemplateInstant(tmplClsCursor, argClsCursor clang.Cursor) {
...
func (this *GenerateNim) genTemplateMethod(cursor, parent clang.Cursor, argClsCursor clang.Cursor) {
...
func (this *GenerateNim) genTemplateInterface(tmplClsCursor, argClsCursor clang.Cursor) {
...
func (this *GenerateNim) genTemplateInterfaceSignature(cursor, parent clang.Cursor, argClsCursor clang.Cursor) {
	clsName := argClsCursor.Spelling()
	elemClsName := clsName[:strings.LastIndexAny(clsName, "LHSM")]
